...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <h1> ${variables.name ? variables.name : "Escribe tu nombre"}
                ${variables.lastname ? variables.lastname : "y apellidos"}</h1>
          <h2>${variables.role ? variables.role : "Select a role"}</h2>
          <h3>${variables.city ? variables.city : "Select city "}
              ${variables.country ? variables.country : "and country"}</h3>
